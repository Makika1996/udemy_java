...
public class LocaleCurrency {
    public static void main(String[] args) {
        ...
        for (Locale locale : Locale.getAvailableLocales()) {
            System.out.printf("%s %s %s %s%n", locale, locale.getLanguage(), locale.getDisplayLanguage(Locale.CANADA_FRENCH), locale.getDisplayCountry(Locale.CHINA));
        ...
        System.out.printf(Locale.GERMAN, "%,f%n", Math.random() * 100000);

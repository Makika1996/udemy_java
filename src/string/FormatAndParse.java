...
//        String format = String.format("%d %d %s%n", 12, 12.3333, "Hallo");
//        System.out.println(format);
        ...
        System.out.printf("%1$s %2$s %1$s", "%", "INHALT");

        // Formater

        Formatter formatter = new Formatter();
        formatter.format("%1$s %2$s %1$s", "%", "INHALT");
        formatter.format("|%-20S|%n", xmas);
        ...
        // Scanner
//        Scanner scanner = new Scanner("12 234 2354 45");

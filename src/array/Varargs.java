...
public class Varargs {
    public static void main(String[] args) {
        ...
        System.out.printf("%s %d%n", "Hallo", 12, 12);
        System.out.printf("%s %d%n", "Hallo", 12, 12, 23452345, 353, 5);
        System.out.printf("%s %d%n", "Hallo", 12, 12, "asdf", 3445.);
...
//        print(null);            // -> new String[]{null} ?????? -> falsch
    ...
    public static void printInts(int... numbers) { // -> (int[] number)

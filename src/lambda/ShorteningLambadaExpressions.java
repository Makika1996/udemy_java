...
/**
 * Lernziel: Abkürzung von Lambda-Ausdrücken
...
public class ShorteningLambadaExpressions {
    public static void main(String[] args) {
        Predicate<String> isEmpty = (String s) -> {
            return s.isEmpty();
        };
